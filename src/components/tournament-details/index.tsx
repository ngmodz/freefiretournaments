          ...
          <AlertDialogContent className="max-w-md mx-4 sm:mx-auto">
            <AlertDialogHeader className="text-center sm:text-left">
              ...
              <AlertDialogDescription className="text-sm sm:text-base">
                {missingFields.ign && missingFields.uid ? (
                  <>
                    To join tournaments, please update your <b>IGN</b> (in-game name) and <b>UID</b> (8-12 digit Free Fire ID) in your profile.
                  </>
                ) : missingFields.ign ? (
                  <>Complete your profile by adding your <b>IGN</b> (in-game name) to join tournaments.</>
                ) : (
                  <>Complete your profile by adding your <b>UID</b> (8-12 digit Free Fire ID) to join tournaments.</>
                )}
              </AlertDialogDescription>
            </AlertDialogHeader>
