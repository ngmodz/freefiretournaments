      ...
      <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogPortal>
          ...
          <DialogPrimitive.Content
            className="fixed inset-0 flex items-center justify-center z-50 p-4 sm:p-6 overflow-x-hidden"
          >
            <motion.div 
              ...
              className="w-full max-w-md bg-gradient-to-b from-gaming-card to-gaming-bg text-gaming-text rounded-lg shadow-lg border border-gaming-primary/20 backdrop-blur-sm max-h-[75vh] sm:max-h-none overflow-y-auto sm:overflow-y-visible overflow-x-hidden"
            >
