      ...
      <DialogPortal>
        ...
        >
          <motion.div 
            ...
            className="w-full max-w-md bg-gradient-to-b from-gaming-card to-gaming-bg text-gaming-text rounded-lg shadow-lg border border-gaming-primary/20 backdrop-blur-sm overflow-hidden"
          >
